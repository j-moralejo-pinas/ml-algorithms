...
This guide provides step-by-step instructions for installing and setting up the ml-algorithms project template. Choose the installation section that best fits your needs.
...
.. code-block::
    ...
    python -c "import ml_algorithms; print('Installation successful!')"
...
.. code-block::
    ...
    docker-compose run --rm app python -c "import ml_algorithms; print('Docker installation successful!')"
...
.. code-block::
    ...
    conda create -n ml-algorithms-dev python=3.14
    conda activate ml-algorithms-dev
...
.. code-block::
    ...
    python -c "import ml_algorithms; print('Development installation successful!')"
    pytest --version
    ruff --version
    pyright --version
...
.. code-block::
    ...
    conda activate ml-algorithms-dev  # Activate the environment
...
* Check the project's GitHub issues: https://github.com/j-moralejo-pinas/ml-algorithms/issues
